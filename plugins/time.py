...
def time(inp, nick="", reply=None, db=None, notice=None):
    ...
    try:
        ...
        prefix = html.xpath("//div[@class='vk_c vk_gy vk_sh _n']//span[@class='vk_gy vk_sh']/text()")[0].strip()
        print prefix
        time = html.xpath("//div[@class='vk_c vk_gy vk_sh _n']//div[@class='vk_bk vk_ans']/text()")[0].strip()
        day = html.xpath("//div[@class='vk_c vk_gy vk_sh _n']//div[@class='vk_gy vk_sh']/text()")[0].strip()
        date = html.xpath("//div[@class='vk_c vk_gy vk_sh _n']//div[@class='vk_gy vk_sh']/span/text()")[0].strip()
    except IndexError:
