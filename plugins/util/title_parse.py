...
def parse_title_chunk(tokens):
    ...
    for tkn in tokens:
        if (not in_title and tkn[0] == 'TITLE'):
            ...
            if (tkn[0] == 'DEC_CHAR_ENT' or
                    tkn[0] == 'HEX_CHAR_ENT'):
                try:
                    cvalue = char(int(tkn[1],
                                      10
...
# See: https://github.com/python/cpython/blob/3.8/Lib/html/entities.py#L264
char_entities = {
    'Aacute': u'\xc1',
    'aacute': u'\xe1',
    'Aacute;': u'\xc1',
...
if __name__ == '__main__':
    ...
    with open(argv[1], 'rb') as f:
        print(parse_title_chunk(tokenize_title_chunk(f.read().decode('utf-8', 'ignore'))))
